...
def main(page: ft.Page):
    ...
    def open_snack(event):
        snack.open = True
        snack.update()

    pb = ft.PopupMenuButton(
        items=[
            ft.PopupMenuItem(text="Item 1", on_click=open_snack),
    ...
    snack = SnackBar(
        on_visible=lambda e: open_up_snack(e),
        ...
        content=Row(
            ...
            controls=[
                Container(
                    width=150, height=40,
                    scale=0, on_animation_end=lambda e: end_animation(e),
                    ...
                    content=Text("Search is loading", size=14, text_align=TextAlign.CENTER, weight=FontWeight.W_600),
                ),
            ],
        ),
    )
